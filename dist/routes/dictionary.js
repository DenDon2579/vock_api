    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default
                    .get("https://dictionary.yandex.net/api/v1/dicservice.json/lookup?key=dict.1.1.20231114T095349Z.e9533bbdd5907c47.5066f417c100bcd5afaa9c90593faf7f6a47428d&lang=en-ru&text=".concat(req.body.text))
                ...
                if (translations.def.length > 0) {
                    responceTranslations = translations.def.map(function (block) { return ({
                        ...
                        words: block.tr
                            ...
                            .filter(function (translation) { return translation.popularity >= 5; }),
                    }); });
